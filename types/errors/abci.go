...
func ResponseCheckTx(err error, gw, gu uint64, debug bool) tmabci.ResponseCheckTx {
...
func ResponseCheckTxWithEvents(err error, gw, gu uint64, events []abci.Event, debug bool) tmabci.ResponseCheckTx {
	space, code, log := ABCIInfo(err, debug)
	return tmabci.ResponseCheckTx{
		Codespace: space,
		Code:      code,
