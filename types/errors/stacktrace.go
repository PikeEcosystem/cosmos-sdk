...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/PikeEcosystem/cosmos-sdk/types/errors.Wrap",
		"github.com/PikeEcosystem/cosmos-sdk/types/errors.Wrapf",
		"github.com/PikeEcosystem/cosmos-sdk/types/errors.WithType",
