...
type Params struct {
	FoundationTax github_com_PikeEcosystem_cosmos_sdk_types.Dec `protobuf:"bytes,1,opt,name=foundation_tax,json=foundationTax,proto3,customtype=github.com/PikeEcosystem/cosmos-sdk/types.Dec" json:"foundation_tax"`
}
...
type ThresholdDecisionPolicy struct {
	...
	Threshold github_com_PikeEcosystem_cosmos_sdk_types.Dec `protobuf:"bytes,1,opt,name=threshold,proto3,customtype=github.com/PikeEcosystem/cosmos-sdk/types.Dec" json:"threshold"`
...
type PercentageDecisionPolicy struct {
	...
	Percentage github_com_PikeEcosystem_cosmos_sdk_types.Dec `protobuf:"bytes,1,opt,name=percentage,proto3,customtype=github.com/PikeEcosystem/cosmos-sdk/types.Dec" json:"percentage"`
	// windows defines the different windows for voting and execution.
	Windows *DecisionPolicyWindows `protobuf:"bytes,2,opt,name=windows,proto3" json:"windows,omitempty"`
}
...
type FoundationInfo struct {
	...
	TotalWeight github_com_PikeEcosystem_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=total_weight,json=totalWeight,proto3,customtype=github.com/PikeEcosystem/cosmos-sdk/types.Dec" json:"total_weight"`
...
type TallyResult struct {
	...
	YesCount github_com_PikeEcosystem_cosmos_sdk_types.Dec `protobuf:"bytes,1,opt,name=yes_count,json=yesCount,proto3,customtype=github.com/PikeEcosystem/cosmos-sdk/types.Dec" json:"yes_count"`
	// abstain_count is the sum of abstainers.
	AbstainCount github_com_PikeEcosystem_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=abstain_count,json=abstainCount,proto3,customtype=github.com/PikeEcosystem/cosmos-sdk/types.Dec" json:"abstain_count"`
	// no is the sum of no votes.
	NoCount github_com_PikeEcosystem_cosmos_sdk_types.Dec `protobuf:"bytes,3,opt,name=no_count,json=noCount,proto3,customtype=github.com/PikeEcosystem/cosmos-sdk/types.Dec" json:"no_count"`
	// no_with_veto_count is the sum of veto.
	NoWithVetoCount github_com_PikeEcosystem_cosmos_sdk_types.Dec `protobuf:"bytes,4,opt,name=no_with_veto_count,json=noWithVetoCount,proto3,customtype=github.com/PikeEcosystem/cosmos-sdk/types.Dec" json:"no_with_veto_count"`
}
...
type Pool struct {
	Treasury github_com_PikeEcosystem_cosmos_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=treasury,proto3,castrepeated=github.com/PikeEcosystem/cosmos-sdk/types.DecCoins" json:"treasury"`
}
...
func (m *Pool) GetTreasury() github_com_PikeEcosystem_cosmos_sdk_types.DecCoins {
	if m != nil {
		return m.Treasury
	}
	return nil
