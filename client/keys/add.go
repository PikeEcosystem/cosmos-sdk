...
import (
	...
	"github.com/PikeEcosystem/cosmos-sdk/client/input"
	"github.com/PikeEcosystem/cosmos-sdk/crypto/hd"
	"github.com/PikeEcosystem/cosmos-sdk/crypto/keyring"
	"github.com/PikeEcosystem/cosmos-sdk/crypto/keys/multisig"
...
const (
	...
	// cosmos-sdk-sdk cannot support the coin type MaxUint32
...
func runAddCmd(ctx client.Context, cmd *cobra.Command, args []string, inBuf *bufio.Reader) error {
	...
	if len(mnemonic) == 0 {
		// read entropy seed straight from picrypto.Rand and convert to mnemonic
