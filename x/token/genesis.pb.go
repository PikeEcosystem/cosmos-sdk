...
type ClassGenesisState struct {
	...
	Nonce github_com_PikeEcosystem_cosmos_sdk_types.Uint `protobuf:"bytes,1,opt,name=nonce,proto3,customtype=github.com/PikeEcosystem/cosmos-sdk/types.Uint" json:"nonce"`
