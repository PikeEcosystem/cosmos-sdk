...
import (
	...
	snapshottypes "github.com/PikeEcosystem/cosmos-sdk/snapshots/types"
...
func (app *BaseApp) BeginBlock(req tmabci.RequestBeginBlock) (res abci.ResponseBeginBlock) {
...
func (app *BaseApp) CheckTxSync(req abci.RequestCheckTx) tmabci.ResponseCheckTx {
...
func (app *BaseApp) CheckTxAsync(req abci.RequestCheckTx, callback tmabci.CheckTxCallback) {
	if req.Type != abci.CheckTxType_New && req.Type != abci.CheckTxType_Recheck {
		panic(fmt.Sprintf("unknown RequestCheckTx type: %s", req.Type))
	}
...
func (app *BaseApp) BeginRecheckTx(req tmabci.RequestBeginRecheckTx) tmabci.ResponseBeginRecheckTx {
	// NOTE: This is safe because Tendermint holds a lock on the mempool for Rechecking.
	app.setCheckState(req.Header)
	return tmabci.ResponseBeginRecheckTx{Code: abci.CodeTypeOK}
}

// EndRecheckTx implements the ABCI interface.
func (app *BaseApp) EndRecheckTx(req tmabci.RequestEndRecheckTx) tmabci.ResponseEndRecheckTx {
	return tmabci.ResponseEndRecheckTx{Code: abci.CodeTypeOK}
}
