...
type ClassStatistics struct {
	...
	// statistics
	Amount github_com_PikeEcosystem_cosmos_sdk_types.Int `protobuf:"bytes,2,opt,name=amount,proto3,customtype=github.com/PikeEcosystem/cosmos-sdk/types.Int" json:"amount"`
}
...
type NextClassIDs struct {
	...
	Fungible github_com_PikeEcosystem_cosmos_sdk_types.Uint `protobuf:"bytes,2,opt,name=fungible,proto3,customtype=github.com/PikeEcosystem/cosmos-sdk/types.Uint" json:"fungible"`
	// id for the non-fungible tokens.
	NonFungible github_com_PikeEcosystem_cosmos_sdk_types.Uint `protobuf:"bytes,3,opt,name=non_fungible,json=nonFungible,proto3,customtype=github.com/PikeEcosystem/cosmos-sdk/types.Uint" json:"non_fungible"`
}
...
type NextTokenID struct {
	...
	ClassId string `protobuf:"bytes,1,opt,name=class_id,json=classId,proto3" json:"class_id,omitempty"`
	// id for the token.
	Id github_com_PikeEcosystem_cosmos_sdk_types.Uint `protobuf:"bytes,2,opt,name=id,proto3,customtype=github.com/PikeEcosystem/cosmos-sdk/types.Uint" json:"id"`
}
