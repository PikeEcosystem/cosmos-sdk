...
import (
	...
	ostcmd "github.com/PikeEcosystem/tendermint/cmd/tendermint/commands"
	...
	"github.com/PikeEcosystem/tendermint/rpc/client/local"
	...
	servergrpc "github.com/PikeEcosystem/cosmos-sdk/server/grpc"
	"github.com/PikeEcosystem/cosmos-sdk/server/rosetta"
	crgserver "github.com/PikeEcosystem/cosmos-sdk/server/rosetta/lib/server"
...
`,
		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			withOST, _ := cmd.Flags().GetBool(flagWithTendermint)
			if !withOST {
