...
func (fss *StreamingService) ListenBeginBlock(ctx sdk.Context, req tmabci.RequestBeginBlock, res abci.ResponseBeginBlock) error {
...
func (fss *StreamingService) openBeginBlockFile(req tmabci.RequestBeginBlock) (*os.File, error) {
