...
type MsgIssueFT struct {
	...
	Amount github_com_PikeEcosystem_cosmos_sdk_types.Int `protobuf:"bytes,8,opt,name=amount,proto3,customtype=github.com/PikeEcosystem/cosmos-sdk/types.Int" json:"amount"`
}
