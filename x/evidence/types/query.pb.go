...
import (
	...
	github_com_cosmos_sdk_tendermint_libs_bytes "github.com/PikeEcosystem/tendermint/libs/bytes"
...
type QueryEvidenceRequest struct {
	...
	EvidenceHash github_com_cosmos_sdk_tendermint_libs_bytes.HexBytes `protobuf:"bytes,1,opt,name=evidence_hash,json=evidenceHash,proto3,casttype=github.com/PikeEcosystem/tendermint/libs/bytes.HexBytes" json:"evidence_hash,omitempty"`
}
...
func (m *QueryEvidenceRequest) GetEvidenceHash() github_com_cosmos_sdk_tendermint_libs_bytes.HexBytes {
	if m != nil {
...
var fileDescriptor_07043de1a84d215a = []byte{
	...
	,
}
