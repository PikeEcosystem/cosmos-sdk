...
type QueryTreasuryResponse struct {
	Amount github_com_PikeEcosystem_cosmos_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=amount,proto3,castrepeated=github.com/PikeEcosystem/cosmos-sdk/types.DecCoins" json:"amount"`
}
...
func (m *QueryTreasuryResponse) GetAmount() github_com_PikeEcosystem_cosmos_sdk_types.DecCoins {
	if m != nil {
		return m.Amount
	}
	return nil
