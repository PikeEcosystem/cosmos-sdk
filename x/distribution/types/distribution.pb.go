...
type Params struct {
	CommunityTax        github_com_PikeEcosystem_cosmos_sdk_types.Dec `protobuf:"bytes,1,opt,name=community_tax,json=communityTax,proto3,customtype=github.com/PikeEcosystem/cosmos-sdk/types.Dec" json:"community_tax" yaml:"community_tax"`
	BaseProposerReward  github_com_PikeEcosystem_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=base_proposer_reward,json=baseProposerReward,proto3,customtype=github.com/PikeEcosystem/cosmos-sdk/types.Dec" json:"base_proposer_reward" yaml:"base_proposer_reward"`
	BonusProposerReward github_com_PikeEcosystem_cosmos_sdk_types.Dec `protobuf:"bytes,3,opt,name=bonus_proposer_reward,json=bonusProposerReward,proto3,customtype=github.com/PikeEcosystem/cosmos-sdk/types.Dec" json:"bonus_proposer_reward" yaml:"bonus_proposer_reward"`
...
type ValidatorHistoricalRewards struct {
	CumulativeRewardRatio github_com_PikeEcosystem_cosmos_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=cumulative_reward_ratio,json=cumulativeRewardRatio,proto3,castrepeated=github.com/PikeEcosystem/cosmos-sdk/types.DecCoins" json:"cumulative_reward_ratio" yaml:"cumulative_reward_ratio"`
...
func (m *ValidatorHistoricalRewards) GetCumulativeRewardRatio() github_com_PikeEcosystem_cosmos_sdk_types.DecCoins {
	if m != nil {
...
func (m *ValidatorCurrentRewards) GetRewards() github_com_PikeEcosystem_cosmos_sdk_types.DecCoins {
	if m != nil {
		return m.Rewards
	}
	return nil
...
type ValidatorAccumulatedCommission struct {
	Commission github_com_PikeEcosystem_cosmos_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=commission,proto3,castrepeated=github.com/PikeEcosystem/cosmos-sdk/types.DecCoins" json:"commission"`
}
...
func (m *ValidatorAccumulatedCommission) GetCommission() github_com_PikeEcosystem_cosmos_sdk_types.DecCoins {
	if m != nil {
		return m.Commission
	}
	return nil
...
type ValidatorOutstandingRewards struct {
	Rewards github_com_PikeEcosystem_cosmos_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=rewards,proto3,castrepeated=github.com/PikeEcosystem/cosmos-sdk/types.DecCoins" json:"rewards" yaml:"rewards"`
}
...
func (m *ValidatorOutstandingRewards) GetRewards() github_com_PikeEcosystem_cosmos_sdk_types.DecCoins {
	if m != nil {
		return m.Rewards
	}
	return nil
...
type ValidatorSlashEvent struct {
	...
	Fraction        github_com_PikeEcosystem_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=fraction,proto3,customtype=github.com/PikeEcosystem/cosmos-sdk/types.Dec" json:"fraction"`
}
...
type FeePool struct {
	CommunityPool github_com_PikeEcosystem_cosmos_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=community_pool,json=communityPool,proto3,castrepeated=github.com/PikeEcosystem/cosmos-sdk/types.DecCoins" json:"community_pool" yaml:"community_pool"`
}
...
func (m *FeePool) GetCommunityPool() github_com_PikeEcosystem_cosmos_sdk_types.DecCoins {
	if m != nil {
...
type CommunityPoolSpendProposal struct {
	...
	Amount      github_com_PikeEcosystem_cosmos_sdk_types.Coins `protobuf:"bytes,4,rep,name=amount,proto3,castrepeated=github.com/PikeEcosystem/cosmos-sdk/types.Coins" json:"amount"`
}
...
type DelegatorStartingInfo struct {
	...
	Stake          github_com_PikeEcosystem_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=stake,proto3,customtype=github.com/PikeEcosystem/cosmos-sdk/types.Dec" json:"stake" yaml:"stake"`
...
type DelegationDelegatorReward struct {
	...
	Reward           github_com_PikeEcosystem_cosmos_sdk_types.DecCoins `protobuf:"bytes,2,rep,name=reward,proto3,castrepeated=github.com/PikeEcosystem/cosmos-sdk/types.DecCoins" json:"reward"`
}
...
var fileDescriptor_cd78a31ea281a992 = []byte{
	...
	0x6f, 0x95, 0xf7, 0x98, 0x2f, 0xdd, 0x06, 0x23, 0xe5, 0x23, 0xf3, 0x71, 0x47, 0x7a, 0xf7, 0xcb,
	...
	0x2d, 0x17, 0xbd, 0x97, 0x5f, 0xfd, 0x27, 0x00, 0x00, 0xff, 0xff, 0xf2, 0x04, 0x25, 0xde, 0xb4,
	0x0b, 0x00, 0x00,
}
