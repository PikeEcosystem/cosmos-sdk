...
import (
	...
	"github.com/PikeEcosystem/cosmos-sdk/x/upgrade/keeper"
	"github.com/PikeEcosystem/cosmos-sdk/x/upgrade/types"
)
...
func TestHaltIfTooNew(t *testing.T) {
	...
	req = tmabci.RequestBeginBlock{Header: futCtx.BlockHeader()}
	require.NotPanics(t, func() {
...
func TestNoSpuriousUpgrades(t *testing.T) {
	...
	req := tmabci.RequestBeginBlock{Header: s.ctx.BlockHeader()}
	require.NotPanics(t, func() {
...
func TestBinaryVersion(t *testing.T) {
	...
	testCases := []struct {
		name        string
		preRun      func() (sdk.Context, tmabci.RequestBeginBlock)
		expectPanic bool
	}{
		{
			"test not panic: no scheduled upgrade or applied upgrade is present",
			func() (sdk.Context, tmabci.RequestBeginBlock) {
				req := tmabci.RequestBeginBlock{Header: s.ctx.BlockHeader()}
				return s.ctx, req
			},
			false,
