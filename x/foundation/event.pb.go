...
func (m *EventFundTreasury) GetAmount() github_com_PikeEcosystem_cosmos_sdk_types.Coins {
	if m != nil {
		return m.Amount
	}
	return nil
...
func (m *EventWithdrawFromTreasury) GetAmount() github_com_PikeEcosystem_cosmos_sdk_types.Coins {
	if m != nil {
		return m.Amount
	}
	return nil
