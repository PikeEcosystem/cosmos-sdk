...
type QueryFTSupplyResponse struct {
	...
	Supply github_com_PikeEcosystem_cosmos_sdk_types.Int `protobuf:"bytes,1,opt,name=supply,proto3,customtype=github.com/PikeEcosystem/cosmos-sdk/types.Int" json:"supply"`
}
...
type QueryFTMintedResponse struct {
	...
	Minted github_com_PikeEcosystem_cosmos_sdk_types.Int `protobuf:"bytes,1,opt,name=minted,proto3,customtype=github.com/PikeEcosystem/cosmos-sdk/types.Int" json:"minted"`
}
...
type QueryFTBurntResponse struct {
	...
	Burnt github_com_PikeEcosystem_cosmos_sdk_types.Int `protobuf:"bytes,1,opt,name=burnt,proto3,customtype=github.com/PikeEcosystem/cosmos-sdk/types.Int" json:"burnt"`
}
