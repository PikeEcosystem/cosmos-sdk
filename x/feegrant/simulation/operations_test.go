...
import (
	...
	"github.com/PikeEcosystem/cosmos-sdk/x/feegrant/simulation"
)
...
func (suite *SimTestSuite) TestSimulateMsgRevokeAllowance() {
	...
	// begin a new block
	app.BeginBlock(tmabci.RequestBeginBlock{Header: tmproto.Header{Height: suite.app.LastBlockHeight() + 1, AppHash: suite.app.LastCommitID().Hash}})
