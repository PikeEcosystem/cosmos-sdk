...
type BeginBlockAppModule interface {
	AppModule
	BeginBlock(sdk.Context, tmabci.RequestBeginBlock)
}
...
func (gam GenesisOnlyAppModule) BeginBlock(ctx sdk.Context, req tmabci.RequestBeginBlock) {}
...
// modules.
func (m *Manager) BeginBlock(ctx sdk.Context, req tmabci.RequestBeginBlock) abci.ResponseBeginBlock {
